      ...
      <Row>
        ...
        <Col width={colWidth}>
          ...
          {hasData(positiveField) ? (
            ...
            <ChartAlert
              message={`${state.name} does not have any current COVID-19 cases.`}
            />
          )}
        </Col>
        <Col width={colWidth}>
          ...
          {hasData(hospitalizedField) ? (
            ...
            <ChartAlert
              message={`${state.name} does not report data on current COVID-19 hospitalizations.`}
            />
          )}
        </Col>
        <Col width={colWidth}>
          ...
          {hasData(deathField) ? (
            ...
            <ChartAlert
              message={`${state.name} does not have any current COVID-19 deaths.`}
            />
          )}
        </Col>
      </Row>
