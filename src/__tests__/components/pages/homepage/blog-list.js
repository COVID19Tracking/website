    ...
    allContentfulBlogPost: {
      edges: [
      {
        node: {
          ...
          lede: {
            lede: "We're rolling out a new, more rigorous system for grading the public health data each state reports. This new scoring system sets a more comprehensive and exact standard for evaluating how complete and meaningful each state’s data is."
          }
        }
      },
      {
        node: {
          ...
          lede: {
            lede: "The COVID-19 pandemic isn't affecting all communities the same way. That's why we're partnering with American University’s Antiracist Research & Policy Center to launch a new project: the COVID Racial Data Tracker."
          }
        }
      }
      ]
