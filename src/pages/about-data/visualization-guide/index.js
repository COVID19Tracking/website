    ...
    >
      <LongContent>
        ...
        <div className={dashboardStyles.moduleFeatured}>
          ...
          <p>
            Because COVID-19 testing and reporting are inconsistent among
            states, it&rsquo;s easy to misinterpret the data. That makes it
            especially important to create clear and accurate visualizations.
            Otherwise even simple and minimalistic graphics can be misleading.
            If you plan to display data from the COVID Tracking Project
            yourself, please closely follow these design and visualization
            guidelines.
          </p>
          ...
          <p>
            ...
            (where each state is shaded in proportion to a statistical
            variable), make sure you encode a population-controlled rate, such
            as &ldquo;positive tests per one million people.&rdquo; If you want
            to show absolute numbers, such as the number of new positive cases
            per day, use a{' '}
          ...
          <p>
            ...
            application of this is in your color choice: You don&rsquo;t want
            your map&rsquo;s color scheme or design to minimize the situation by
            being overly playful or lighthearted. You also don&rsquo;t want to
            select colors that suggest the worst possible outcome.
          </p>
        </div>
        ...
        <div className={dashboardStyles.moduleFeatured}>
          ...
          <p>
            Testing is one of the most important tools in controlling an
            outbreak. When universal testing is implemented, people who are
            infected with the virus can be isolated from folks who test
            negative. This functions as a targeted social distancing technique
            and can help slow the outbreak.
          </p>
          <p>
            Charting the number of positive tests alone is often problematic.
            Simple case counts show where people are being tested, not
            necessarily where people are sick. To illustrate the point, a state
            that reports three cases of COVID-19 after testing 2,000 people is
            probably in a different stage of its outbreak than a state that
            reports three cases but has only tested 20 people. But if all you
            have is a case count, those states look exactly the same. That is
            why we need to include the total number of tests as a denominator.
          </p>
        </div>
        ...
        <div className={dashboardStyles.moduleFeatured}>
          ...
          <p>
            ...
            its data differently. We track numbers provided by each state, but
          ...
          <p>
            An organized, collective, and timely response from the government
            and other authorities is a key factor in saving lives. One metric
            you can use to measure the response’s effectiveness is the number of
            deaths attributed to the virus per day and/or per state or
            territory.
          </p>
          <p>
            We recommend using total numbers for plotting deaths to compare one
            US state or territory against another. In this case, adjusting per
            capita adds a layer of abstraction to the graphic. This reduces the
        ...
        <div className={dashboardStyles.moduleFeatured}>
          ...
          <p>
            ...
            some experts prefer to measure the pandemic&rsquo;s severity using
            the number of deaths instead of total cases, several factors could
            bias COVID-19 mortality data.
          </p>
          <p>
            There are some concerns that official death statistics may overcount
            COVID-19 fatalities by assuming any patient who tests positive for
            the virus was killed by it. But Marc Lipsitch, a Harvard University
            epidemiologist, told{' '}
            ...
            Undercounting is a bigger problem, he says. &ldquo;A greater issue
            is errors in the other direction.&rdquo;
          </p>
          <p>
            If people die from COVID-19 before they are tested, their death
            might not be included in the official tally. For example, a{' '}
            ...
            found that as of Tuesday, April 7, around 200 New Yorkers had died
            at home every day without access to testing and medical treatment.
          ...
          <p>
            While news is moving faster than ever to keep up with the pace of
            the pandemic spread, designers and visualization experts&rsquo; goal
            is to present COVID-19 data in a clear and honest way. Provide
            context, and consider the tips above to avoid common pitfalls in
            data reporting as we seek to inform people during this time of
            crisis.
          </p>
          <aside className="notes-section">
            ...
            <p>
              ...
              negative value for each state. This is to account for differences
              in how states reporting pending tests.
            </p>
            <p>
              ...
              sources. This led to a drop in California&rsquo;s reported cases
              and deaths in our dataset on April 1, since the state&rsquo;s data
              lags behind our previous sources.
            </p>
