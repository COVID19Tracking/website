/* eslint-disable  */
// This file is built from: https://github.com/maerzhase/react-scrollama a fork of the original project that works with Gatsby
'use strict'
  ...
  function Scrollama(props) {
    ...
    _defineProperty(
      ...
      function(name) {
        return (
          _this.io[name] &&
          _this.io[name].forEach(function(o) {
            return o.disconnect()
          })
        )
      },
    ...
    _defineProperty(_assertThisInitialized(_this), 'handleEnable', function(
      enable,
    ) {
    ...
    _defineProperty(
      ...
      function() {
        ...
        _this.io.stepAbove = _this.stepElIds.map(function(id) {
          ...
          var options = {
            rootMargin: ''
              .concat(marginTop, 'px 0px ')
              .concat(marginBottom, 'px 0px'),
          }
    ...
    _defineProperty(
      ...
      function(_ref) {
        ...
        if (
          ...
          _this.notifyStepEnter(step, _this.direction) // Exiting from above means not intersecting and topAdjusted is positive

        if (
          !isIntersecting && // Should be >0, but >-0.05 fixes a weird floating point issue in Chrome.
          // The exact –ε is different for every this.prop.offset. Very sad folks.
          topAdjusted > -0.5 &&
          _this.direction === 'up' &&
          step.state.state === 'enter'
        )
          _this.notifyStepExit(step, _this.direction)
      },
    )
    ...
    _defineProperty(
      ...
      function(_ref3) {
        ...
        if (
          ...
          _this.notifyStepEnter(step, _this.direction)
        if (
          !isIntersecting &&
          bottomAdjusted < 0 &&
          _this.direction === 'down' &&
    ...
    _defineProperty(
      ...
      function(_ref5) {
        ...
        if (isIntersecting && bottomAdjusted >= 0)
          _this.notifyStepProgress(_this.getStep(target), intersectionRatio)
      },
    )

    _defineProperty(_assertThisInitialized(_this), 'createThreshold', function(
      height,
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), 'notifyStepEnter', function(
      step,
      direction,
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), 'notifyStepExit', function(
      step,
      direction,
    ) {
      if (_this.progressMode) {
        if (direction === 'down' && step.state.progress < 1)
          _this.notifyStepProgress(step, 1)
        if (direction === 'up' && step.state.progress > 0)
          _this.notifyStepProgress(step, 0)
      }
    ...
    var _this$props = _this.props,
      ...
      _progress =
        _this$props$progress === void 0 ? false : _this$props$progress,
    ...
    if (offset && !isNaN(offset))
      _this.offsetVal = Math.min(Math.max(0, offset), 1)
    ...
    },
    {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ React__default.createElement(
          ...
          null,
          this.isDebug &&
            /*#__PURE__*/ React__default.createElement(DebugOffset, {
              offsetMargin: this.state.offsetMargin,
              offsetVal: this.offsetVal,
            }),
          React__default.Children.map(this.props.children, function(
            child,
            index,
          ) {
...
var Step = /*#__PURE__*/ (function(_Component) {
  ...
  function Step() {
    ...
    _defineProperty(
      _assertThisInitialized(_this),
      'nodeRef',
      /*#__PURE__*/ React__default.createRef(),
    )
